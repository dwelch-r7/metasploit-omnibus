...
build do
  ...
  if windows?
    ...
    dlls.each do |dll|
      ...
      # msys_path = ENV["OMNIBUS_TOOLCHAIN_INSTALL_DIR"] ? "#{ENV["OMNIBUS_TOOLCHAIN_INSTALL_DIR"]}/embedded/bin" : "C:/tools/msys2"
      # windows_path = "#{msys_path}/#{mingw}/bin/#{dll}.dll"
      windows_path = "c:/tools/msys64/mingw64/bin/#{dll}.dll"
